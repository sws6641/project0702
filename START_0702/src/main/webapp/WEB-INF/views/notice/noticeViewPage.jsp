...
<style type="text/css">
	...
	.member { /* display: flex; */
		margin: auto; /* border-top: 1px solid gray; */
...
<div class="main-menu">
	...
	<c:if test="${not empty mDTO and mDTO.m_State eq 1 }">
		<div class="member">
			...
			<br> <input type="button" value="목록으로" onclick="location.href='NoticePage'" />
		</div>
	</c:if>
				...
				<div class="admin">
					<form method="post">
						<dl class="head">
							<dt>제목</dt>
							<dd>
								<input type="text" name="n_Title" value="${nDTO.n_Title }"
									width="500px" />
							</dd>
						...
						<dl>
							...
							<dd>
								<textarea name="n_Content" style="width: 700px; height: 200px;">${nDTO.n_Content }</textarea>
							</dd>
						</dl>
