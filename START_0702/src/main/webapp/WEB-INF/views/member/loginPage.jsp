...
<style type="text/css">
	...
	.login-title:hover, .singin-title:hover {
...
<div class="main-menu">
	<div class="main-wrap">
		...
		<div class="login-head">
			<div class="login-title" style="font-weight: bold">
				<a href="#">로그인</a>
			</div>
			<div class="singin-title">
				<a href="askSignUpPage">회원가입</a>
			</div>
		</div>
		<section class="login_wrap">
			<form method="post" class="login-form" style="border: 1px solid gray">
				...
				<div class="id_area">
					<p class="area">아이디</p>
					<div class="input_box">
						<input type="text" name="m_Id" value="<%=savedID%>" /><br />
						<br /> <span id="input_warn_id"></span>
					</div>
				</div>
				<div class="pw_area">
					<p class="area">비밀번호</p>
					<div class="input_box">
						<input type="password" name="m_Pw" placeholder="pw" /><br /> <span
							id="input_warn_pw"></span>
					</div>
				</div>
				<%
					}
				...
				<a href="findIdPage">아이디찾기</a> <a href="findPwPage">비밀번호찾기</a>
