...
<script type="text/javascript">
	// 카운트를 하지 않으면 정규식에 안맞아도 회원가입이 되기때문에 0일때만 가입가능
	var emailauth = '';
	var authKey = '';
...
<style type="text/css">
	...
	.login-title, .singin-title {
		width: 50%;
		padding: 10px 20px;
		margin: 8px 0;
	}
	
	.login-title:hover, .singin-title:hover { /* font-weight: bold; */
...
<div class="main-menu">
	<div class="signIn-head">
		...
		<div class="singin-title" style="font-weight: bold">
		...
		<div>
			...
			<div>
				<input type="password" name="m_Pw" id="m_Pw"
					placeholder="4~20자 대소문자, 숫자 특수문자 포함" value="${mDTO.m_Pw }" /><br />
			</div>
			<span id="pwCheckResult"></span>
		</div>
		<div>
			<p class="area">
				<label for="m_Pw2">* 비밀번호확인</label>
			</p>
			<div>
		...
		<div>
			...
			<div>
				<input type="text" name="m_Email" id="m_Email"
					value="${mDTO.m_Email }" /> <input type="button" id="m_EmailAuth"
					value="인증요청"> <br /> <input type="text"
					name="m_Email_authKey" id="m_Email"> <input type="button"
					value="인증하기" onclick="fn_emailAuthComfirm(this.form)">
			</div>
		...
		<div>
			...
			<div>
				<input type="text" name="m_Address" id="m_Address"
					style="width: 200px;" value="${mDTO.m_Address }" /> <input
					type="button" id="button" onclick="execDaumPostcode()"
					value="우편번호 찾기">
			</div>
			<span id="emailCheckResult"></span>
		</div>
		<h5 style="color: gray;">* 는 필수입력란 입니다.</h5>
		<br> <input type="button" id="signUpBtn" value="가입하기"
