			...
			<tbody>
				...
				<tr>
					...
					<td><input type="text" name="m_Address" id="m_Address"
						value="${mDTO.m_Address }" style="width: 180px" /> <input
						type="button" onclick="execDaumPostcode()" value="우편번호"></td>
				</tr>
				<tr>
					<td>잔액</td>
					<td style="padding-right: 176px"><fmt:formatNumber
							value="${mDTO.m_Money }" />원</td>
				</tr>
				<tr>
					<td colspan="2" style="height: 50px;"><input type="button"
						value="수정하기" onclick="myViewUpdate(this.form)" /> <input
						type="button" value="회원탈퇴" onclick="myViewDelete(this.form)" /> <!--   <input type="reset" id="clearBtn" value="다시 작성" /> --></td>
				</tr>
			</tbody>
		</table>
	</form>
