...
<style type="text/css">
	...
	#back { /* background-color:rgb(195, 214, 155); */
		border: 2px solid rgb(195, 214, 155);
		color: black;
	...
	<form name="f">
		<div class="inner_view">
			...
			<div class="left-wrap">
				<p class="goods_name">
					...
					<Strong class="name" style="font-size: 20px;"> ${pDTO.p_Name } </Strong> 
						<c:if test="${pDTO.s_No ne mDTO.m_No and mDTO.m_No ne 1 and not empty mDTO}">
							<span id="img_location"> <img alt="cart"
								src="resources/img/cart.png" onclick="fn_cart()">
							</span>
						</c:if>
					</span> <br> 
				...
				<p class="goods_price">
					<fmt:formatNumber value="${pDTO.p_Price }" />
				...
				<div class="goods_content">
					...
					<dl>
						...
						<dd style="font-size: 13px;">스팸성 홍보 등의 게시글 도배 및 댓글 도배 행위는
							금지합니다. 거래 제한 품목 등록 시 게시글 무통보 삭제 및 카페 이용제재 처리됩니다.</dd>
					</dl>
				</div>
				<div class="group_btn">
