	...
	<form enctype="multipart/form-data" method="post">
		<div class="inner_view">
			...
			<div class="left-wrap">
				...
				<p class="goods_name">
					상품명 <input type="text" name="p_Name" value="${pDTO.p_Name }" width="350px;" />
				...
				<p class="goods_price">
					가격 <input type="text" name="p_Price" value="${pDTO.p_Price }" />
