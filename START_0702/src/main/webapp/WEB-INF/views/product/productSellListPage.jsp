...
<div class="main-menu">
	...
	<span class="button"><input type="button" value="상품등록" onclick="location.href='productInsertPage'" /></span>
		...
		<tbody>
			...
			<c:if test="${not empty pDTO }">
				...
				<c:forEach var="pDTO" items="${pDTO }">
					<tr>
						<td>
							<a href="productViewPage?p_No=${pDTO.p_No }"><img alt="${pDTO.p_Img_Path }" width="200px;" src="${pageContext.request.contextPath }/resources/storage/${pDTO.p_Img_Path }"></a>
						</td>
						<td>${pDTO.p_Name }</td>
