...
<script type="text/javascript">
	function fn_ProductInsert(f) {
		if (confirm('상품을 등록하시겠습니까?')) {
			...
			if (imgpath != 'jpg' && imgpath != 'png' && imgpath != 'JPG'
					&& imgpath != 'PNG') {
...
<div class="main-menu">
	<form method="post" enctype="multipart/form-data">
		<p class="subtitle">상품등록</p>
		<br>
		<p style="color: gray">판매하고 싶은 상품의 사진과 내용을 작성해서 등록하세요.
		<p>
			<br>
			<br>
		...
		<input type="button" value="등록하기" onclick="fn_ProductInsert(this.form)" />
	</form>
</div>
